...
public class InfisicalUniversalAuthCredential extends AbstractAuthenticatingInfisicalTokenCredential {
  ...
  public InfisicalUniversalAuthCredential(@CheckForNull CredentialsScope scope, @CheckForNull String id,
      @CheckForNull String description, @NonNull String machineIdentityClientId,
  ...
  public String getAccessToken(InfisicalConfiguration configuration) {
    try {
      return infisicalAuth.loginWithUniversalAuth(configuration.getInfisicalUrl(), machineIdentityClientId,
